...
add-year-64: 06-add-year-64.s | build\
...
error-exit.o: 07-error-exit.s | build
	as $(AS_ARGS_32) $(INC_ARGS) -o build/error-exit.o $<
robust-add-year: 07-robust-add-year.s | build\
...
error-exit-64.o: 07-error-exit-64.s | build
	as $(INC_ARGS) -o build/error-exit-64.o $<
robust-add-year-64: 07-robust-add-year-64.s | build\
...
librecord-64.so: build/readrec-64.o build/writerec-64.o | build
	ld -shared -o build/librecord-64.so\
		build/readrec-64.o build/writerec-64.o
writerecs-shared-64: 06-writerecs-64.s build/librecord-64.so | build
...
alloc.o: 09-alloc.s | build
	as $(AS_ARGS_32) $(INC_ARGS) -o build/alloc.o $<
alloc-64.o: 09-alloc-64.s | build
	as $(INC_ARGS) -o build/alloc-64.o $<
readrecs-alloc: 09-readrecs-alloc.s | build\
	...
	ld $(LD_ARGS_32) -o build/readrecs-alloc\
		...
		build/readrec.o build/count-chars.o build/write-newline.o
readrecs-alloc-64: 09-readrecs-alloc-64.s | build\
...
integer-to-string.o: 10-integer-to-string.s | build
	as $(AS_ARGS_32) -o build/integer-to-string.o $<
conversion-program: 10-conversion-program.s | build\
...
integer-to-string-64.o: 10-integer-to-string-64.s | build
	as -o build/integer-to-string-64.o $<
conversion-program-64: 10-conversion-program-64.s | build\
	...
	ld -o build/conversion-program-64 build/conversion-program-64.o\
		...
		build/write-newline-64.o
hello-world-c: 11-hello-world.c | build
