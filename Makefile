...
exit: 03-exit.s
	as $(DEBUG_ARGS) $(AS_ARGS_32) -o build/exit.o $<
	ld $(DEBUG_ARGS) $(LD_ARGS_32) -o build/exit build/exit.o
exit-64: 03-exit-64.s
	as $(DEBUG_ARGS) -o build/exit-64.o $<
	ld $(DEBUG_ARGS) -o build/exit-64 build/exit-64.o
max: 03-max.s
	as $(DEBUG_ARGS) $(AS_ARGS_32) -o build/max.o $<
	ld $(DEBUG_ARGS) $(LD_ARGS_32) -o build/max build/max.o
max-64: 03-max-64.s
	as $(DEBUG_ARGS) -o build/max-64.o $<
	ld $(DEBUG_ARGS) -o build/max-64 build/max-64.o
power: 04-power.s
	as $(DEBUG_ARGS) $(AS_ARGS_32) -o build/power.o $<
	ld $(DEBUG_ARGS) $(LD_ARGS_32) -o build/power build/power.o
power-64: 04-power-64.s
	as $(DEBUG_ARGS) -o build/power-64.o $<
	ld $(DEBUG_ARGS) -o build/power-64 build/power-64.o
factorial: 04-factorial.s
	as $(DEBUG_ARGS) $(AS_ARGS_32) -o build/factorial.o $<
	ld $(DEBUG_ARGS) $(LD_ARGS_32) -o build/factorial build/factorial.o
factorial-64: 04-factorial-64.s
	as $(DEBUG_ARGS) -o build/factorial-64.o $<
	ld $(DEBUG_ARGS) -o build/factorial-64 build/factorial-64.o
toupper: 05-toupper.s
	as $(DEBUG_ARGS) $(AS_ARGS_32) -o build/toupper.o $<
	ld $(DEBUG_ARGS) $(LD_ARGS_32) -o build/toupper build/toupper.o
toupper-64: 05-toupper-64.s
	as $(DEBUG_ARGS) -o build/toupper-64.o $<
	ld $(DEBUG_ARGS) -o build/toupper-64 build/toupper-64.o
readrec.o: 06-readrec.s
	as $(DEBUG_ARGS) $(AS_ARGS_32) $(INC_ARGS) -o build/readrec.o $<
writerec.o: 06-writerec.s
	as $(DEBUG_ARGS) $(AS_ARGS_32) $(INC_ARGS) -o build/writerec.o $<
count-chars.o: 06-count-chars.s
	as $(DEBUG_ARGS) $(AS_ARGS_32) $(INC_ARGS) -o build/count-chars.o $<
write-newline.o: 06-write-newline.s
	as $(DEBUG_ARGS) $(AS_ARGS_32) $(INC_ARGS) -o build/write-newline.o $<
writerecs: 06-writerecs.s\
		writerec.o
	as $(DEBUG_ARGS) $(AS_ARGS_32) $(INC_ARGS) -o build/writerecs.o $<
	ld $(DEBUG_ARGS) $(LD_ARGS_32) -o build/writerecs\
		build/writerec.o build/writerecs.o
readrecs: 06-readrecs.s\
		readrec.o count-chars.o write-newline.o
	as $(DEBUG_ARGS) $(AS_ARGS_32) $(INC_ARGS) -o build/readrecs.o $<
	ld $(DEBUG_ARGS) $(LD_ARGS_32) -o build/readrecs\
		build/readrec.o build/count-chars.o build/write-newline.o\
		build/readrecs.o
add-year: 06-add-year.s\
		readrec.o writerec.o
	as $(DEBUG_ARGS) $(AS_ARGS_32) $(INC_ARGS) -o build/add-year.o $<
	ld $(DEBUG_ARGS) $(LD_ARGS_32) -o build/add-year\
		build/readrec.o build/writerec.o build/add-year.o
readrec-64.o: 06-readrec-64.s
	as $(DEBUG_ARGS) $(INC_ARGS) -o build/readrec-64.o $<
writerec-64.o: 06-writerec-64.s
	as $(DEBUG_ARGS) $(INC_ARGS) -o build/writerec-64.o $<
count-chars-64.o: 06-count-chars-64.s
	as $(DEBUG_ARGS) $(INC_ARGS) -o build/count-chars-64.o $<
write-newline-64.o: 06-write-newline-64.s
	as $(DEBUG_ARGS) $(INC_ARGS) -o build/write-newline-64.o $<
writerecs-64: 06-writerecs-64.s\
		writerec-64.o
	as $(DEBUG_ARGS) $(INC_ARGS) -o build/writerecs-64.o $<
	ld $(DEBUG_ARGS) -o build/writerecs-64\
		build/writerecs-64.o build/writerec-64.o
readrecs-64: 06-readrecs-64.s\
		readrec-64.o count-chars-64.o write-newline-64.o
	as $(DEBUG_ARGS) $(INC_ARGS) -o build/readrecs-64.o $<
	ld $(DEBUG_ARGS) -o build/readrecs-64\
...
add-year-64: 06-add-year-64.s\
	...
	as $(DEBUG_ARGS) $(INC_ARGS) -o build/add-year-64.o $<
	ld $(DEBUG_ARGS) -o build/add-year-64\
		build/add-year-64.o build/readrec-64.o build/writerec-64.o
error-exit.o: 07-error-exit.s
	as $(DEBUG_ARGS) $(AS_ARGS_32) $(INC_ARGS) -o build/error-exit.o $<
robust-add-year: 07-robust-add-year.s\
		error-exit.o write-newline.o count-chars.o readrec.o writerec.o
	as $(DEBUG_ARGS) $(AS_ARGS_32) $(INC_ARGS) -o build/robust-add-year.o $<
	ld $(DEBUG_ARGS) $(LD_ARGS_32) -o build/robust-add-year\
...
error-exit-64.o: 07-error-exit-64.s
	as $(DEBUG_ARGS) $(INC_ARGS) -o build/error-exit-64.o $<
robust-add-year-64: 07-robust-add-year-64.s\
		error-exit-64.o write-newline-64.o count-chars-64.o\
		readrec-64.o writerec-64.o
	as $(DEBUG_ARGS) $(INC_ARGS) -o build/robust-add-year-64.o $<
	ld $(DEBUG_ARGS) -o build/robust-add-year-64\
...
helloworld-nolib: 08-helloworld-nolib.s
	as $(DEBUG_ARGS) $(AS_ARGS_32) $(INC_ARGS) -o build/helloworld-nolib.o $<
	ld $(DEBUG_ARGS) $(LD_ARGS_32) -o build/helloworld-nolib build/helloworld-nolib.o
helloworld-lib: 08-helloworld-lib.s
	as $(DEBUG_ARGS) $(AS_ARGS_32) $(INC_ARGS) -o build/helloworld-lib.o $<
	ld $(DEBUG_ARGS) $(LD_ARGS_32) -dynamic-linker /lib/ld-linux.so.2 -lc\
		-o build/helloworld-lib build/helloworld-lib.o
helloworld-nolib-64: 08-helloworld-nolib-64.s
	as $(DEBUG_ARGS) $(INC_ARGS) -o build/helloworld-nolib-64.o $<
	ld $(DEBUG_ARGS) -o build/helloworld-nolib-64 build/helloworld-nolib-64.o
helloworld-lib-64: 08-helloworld-lib-64.s
	as $(DEBUG_ARGS) $(INC_ARGS) -o build/helloworld-lib-64.o $<
...
printf-example: 08-printf-example.s
	as $(DEBUG_ARGS) $(AS_ARGS_32) $(INC_ARGS) -o build/printf-example.o $<
	ld $(DEBUG_ARGS) $(LD_ARGS_32) -dynamic-linker /lib/ld-linux.so.2 -lc\
...
writerecs-shared: 06-writerecs.s\
		librecord.so
	as $(DEBUG_ARGS) $(AS_ARGS_32) $(INC_ARGS) -o build/writerecs-shared.o $<
...
writerecs-shared-64: 06-writerecs-64.s\
		librecord-64.so
	as $(DEBUG_ARGS) $(INC_ARGS) -o build/writerecs-shared-64.o $<
	ld $(DEBUG_ARGS) -dynamic-linker /lib64/ld-linux-x86-64.so.2 -L build -lrecord-64\
		-o build/writerecs-shared-64 build/writerecs-shared-64.o
alloc.o: 09-alloc.s
	as $(DEBUG_ARGS) $(AS_ARGS_32) $(INC_ARGS) -o build/alloc.o $<
alloc-64.o: 09-alloc-64.s
	as $(DEBUG_ARGS) $(INC_ARGS) -o build/alloc-64.o $<
readrecs-alloc: 09-readrecs-alloc.s\
		readrec.o count-chars.o write-newline.o alloc.o
	as $(DEBUG_ARGS) $(AS_ARGS_32) $(INC_ARGS) -o build/readrecs-alloc.o $<
	ld $(DEBUG_ARGS) $(LD_ARGS_32) -o build/readrecs-alloc\
...
readrecs-alloc-64: 09-readrecs-alloc-64.s\
	...
	as $(DEBUG_ARGS) $(INC_ARGS) -o build/readrecs-alloc-64.o $<
	ld $(DEBUG_ARGS) -o build/readrecs-alloc-64\
...
integer-to-string.o: 10-integer-to-string.s
	as $(DEBUG_ARGS) $(AS_ARGS_32) -o build/integer-to-string.o $<
conversion-program: 10-conversion-program.s\
		integer-to-string.o count-chars.o write-newline.o
	as $(DEBUG_ARGS) $(AS_ARGS_32) $(INC_ARGS) -o build/conversion-program.o $<
	ld $(DEBUG_ARGS) $(LD_ARGS_32) -o build/conversion-program\
		build/conversion-program.o\
		build/integer-to-string.o build/count-chars.o build/write-newline.o
integer-to-string-64.o: 10-integer-to-string-64.s
	as $(DEBUG_ARGS) -o build/integer-to-string-64.o $<
conversion-program-64: 10-conversion-program-64.s\
	...
	ld $(DEBUG_ARGS) -o build/conversion-program-64 build/conversion-program-64.o\
		build/integer-to-string-64.o build/count-chars-64.o\
		build/write-newline-64.o
hello-world-c: 11-hello-world.c
	gcc $(DEBUG_ARGS) -o build/hello-world-c $<
